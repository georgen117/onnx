...
def DequantizeLinearNBits(
    ...
    **kwargs
    ...
    # if type of zero_points and scaled is not the same then zero_points
    # is a packed N-bit blob and needs to be unpacked.
    ...
    for n in range(0, N):
        ...
        for n_bpc in range(0, n_blocks_per_col):
            unpacked_col_buf = []
            # Unpack the packed bits a blob at a time or until the all K elements have been unpacked
